    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
      <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
          <h3 class="text-lg font-medium leading-6 text-gray-900">Profile for {{product.title}}</h3>
              ...
              <div class="grid grid-cols-3 gap-6">
                <div class="col-span-3 sm:col-span-2">
                  ...
                  <div class="flex mt-1 rounded-md shadow-sm">
                    ...
                    <input type="text" v-model="title" id="title" class="flex-1 block w-full border-gray-300 rounded-none focus:ring-indigo-500 focus:border-indigo-500 rounded-r-md sm:text-sm" :placeholder="`${product.title}`" />
                  </div>
                </div>
              </div>
